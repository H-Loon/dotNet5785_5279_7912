...
namespace PL.Volunteer
{
    ...
    public partial class AdminView : UserControl
    {
        ...
        public static readonly DependencyProperty RiskRangeViewProperty =
            DependencyProperty.Register("RiskRangeView", typeof(TimeSpan), typeof(AdminView));
        public AdminView()
        {
            InitializeComponent();
        }
        ...
        //    {
        //        if (window is MVVM.ViewModel.Volunteer.VolunteerInListWindow)
        //        {
        ...
        //        }
        //    }
        //    new MVVM.ViewModel.Volunteer.VolunteerInListWindow().Show();
        //}
    }
